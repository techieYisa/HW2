...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (Go.equalsIgnoreCase("kitchen")) {
            System.out.println("There is a long counter top with dirty dishes everywhere. Off to one side there is, as you'd expect, a refrigerator. You may open the 'refrigerator' or look in the 'pantry'. ");
            System.out.print(">  ");
            Look = keyboard.next();
            ...
            if (Look.equalsIgnoreCase("refrigerator")) {
                ...
                System.out.println("Wrong move you are now dead. Til next time.");
            }
        }
    }
}
